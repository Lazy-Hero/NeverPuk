...
public class kl extends yk {
   public String m(ks var1) {
      return net.yq.e.E(net.n_.y.h(var1).o("splash_potion.effect."));
   }
   ...
   public am G(net.yv.r var1, net.r.r var2, net.yz.k var3) {
      ...
      var1.L((net.r.r)null, var2.b, var2.hS, var2.hr, net.nb.l.oc, net.yz.p.PLAYERS, 0.5F, 0.4F / (u.nextFloat() * 0.4F + 0.8F));
      if(!var1.x) {
