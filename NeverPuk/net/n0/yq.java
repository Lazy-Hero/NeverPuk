...
public class yq extends y {
   ...
   public am G(net.yv.r var1, net.r.r var2, net.yz.k var3) {
      ...
      var1.L((net.r.r)null, var2.b, var2.hS, var2.hr, net.nb.l.Dm, net.yz.p.PLAYERS, 0.5F, 0.4F / (u.nextFloat() * 0.4F + 0.8F));
      if(!var1.x) {
         net.n1.s var6 = new net.n1.s(var1, var2);
