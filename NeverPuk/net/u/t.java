...
public class t {
   ...
   public static float A(float var0) {
      return W?T[(int)(var0 * 651.8986F) & 4095]:Y[(int)(var0 * 10430.378F) & '\uffff'];
   }

   public static float m(float var0) {
      return W?T[(int)((var0 + 1.5707964F) * 651.8986F) & 4095]:Y[(int)(var0 * 10430.378F + 16384.0F) & '\uffff'];
   }
   ...
   public static float R(double var0) {
      return (float)Math.sqrt(var0);
   }

   public static int M(float var0) {
      int var1 = (int)var0;
      return var0 < (float)var1?var1 - 1:var1;
   }

   public static int N(double var0) {
   ...
   public static long i(double var0) {
      long var2 = (long)var0;
   ...
   public static int Y(float var0) {
      int var1 = (int)var0;
      return var0 > (float)var1?var1 + 1:var1;
   }
   ...
   public static float M(Random var0, float var1, float var2) {
      return var1 >= var2?var1:var0.nextFloat() * (var2 - var1) + var1;
   }

   public static double w(Random var0, double var1, double var3) {
      return var1 >= var3?var1:var0.nextDouble() * (var3 - var1) + var1;
   }

   public static double c(long[] var0) {
      long var1 = 0L;
   ...
   public static boolean C(float var0, float var1) {
      return J(var1 - var0) < 1.0E-5F;
   }
   ...
   public static float K(float var0, float var1) {
      return (var0 % var1 + var1) % var1;
   }
   ...
   public static double p(double var0) {
      var0 = var0 % 360.0D;
      if(var0 >= 180.0D) {
         var0 -= 360.0D;
      }
   ...
   public static double c(String var0, double var1) {
      return Double.parseDouble(var0);
   }

   public static double k(String var0, double var1, double var3) {
      return Math.max(var3, c(var0, var1));
   }
   ...
   public static int L(float var0, float var1, float var2) {
      return f(M(var0 * 255.0F), M(var1 * 255.0F), M(var2 * 255.0F));
   }
   ...
   public static long a(d var0) {
      return g(var0.t(), var0.h(), var0.y());
   }

   public static long g(int var0, int var1, int var2) {
      long var3 = (long)(var0 * 3129871) ^ (long)var2 * 116129781L ^ (long)var1;
      var3 = var3 * var3 * 42317861L + var3 * 11L;
      return var3;
   }

   public static UUID g(Random var0) {
   ...
   public static double V(double var0, double var2) {
      ...
      if(Double.isNaN(var4)) {
         ...
         double var14 = p[var13];
         double var16 = s[var13];
         double var18 = var11 - L;
   ...
   public static int C(float var0, float var1, float var2) {
      ...
      case 5:
      default:
         throw new RuntimeException(a(-14744, 3142) + var0 + a(-14742, 11215) + var1 + a(-14741, 21268) + var2);
      }
   }
